function [opened, vehID, GST, date_time, R, V, year, month_num, day, hour, minute, seconds] = fileRead(fileName)
    ...
    try
        ...
        seconds = fscanf(fileID, '  SEC %f\n', 1); % Reading in seconds variable (line 2)

        vehID = fscanf(fileID, '$ VEHID %d\n', 1); % line 4
        ...
        GST = (hour+(minute/60)+(seconds/3600)); % Converting time into seconds
